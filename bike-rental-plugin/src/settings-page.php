...
<div class="wrap">
	...
	<p><?php esc_html_e( 'Foundation settings only. Public booking is not available in this milestone.', 'bike-rental-plugin' ); ?></p>
	<?php settings_errors(); ?>
	...
	<form action="<?php echo esc_url( admin_url( 'options.php' ) ); ?>" method="post">
		...
		<table class="form-table" role="presentation">
			...
			<tr><th scope="row"><label for="brp-pickup-time"><?php esc_html_e( 'Calendar-day pickup time', 'bike-rental-plugin' ); ?></label></th>
				<td><input type="time" required step="60" id="brp-pickup-time" name="brp_settings[pickup_time]" value="<?php echo esc_attr( $values['pickup_time'] ); ?>"><p class="description"><?php esc_html_e( 'Local time in the WordPress timezone. This setting does not enable bookings.', 'bike-rental-plugin' ); ?></p></td></tr>
		</table>
