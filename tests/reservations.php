...
verify( ! preg_match( '/add_shortcode\s*\(|register_rest_route\s*\(|woocommerce_checkout|wp_remote_|set_stock_quantity\s*\(/', $source ), 'no public booking, checkout, remote integration, or stock sync introduced' );
