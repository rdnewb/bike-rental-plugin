...
The controller is maintained in [rdnewb/nt-license-controller](https://github.com/rdnewb/nt-license-controller). This repository and its ZIP contain only the rental client. Extraction leaves every packaged 0.9.0 client file unchanged. No remote installation or enforcement change was performed.
